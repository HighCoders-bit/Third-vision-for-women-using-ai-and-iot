...
#define WIFI_SSID             "SANYAL"
#define WIFI_PASSWORD         "n@801711"

#define emailSenderAccount    "nairit1998@gmail.com"    //To use send Email for Gmail to port 465 (SSL), less secure app option should be enabled. https://myaccount.google.com/lesssecureapps?pli=1
#define emailSenderPassword   "dtpj xnop afrb dkhp" 

#define emailRecipient        "anuska.june@gmail.com"
